...
class Student {
    ...
    init(firstName f: String, lastName l: String, altIDNumber a: String, idNumber i: String, checkedInOrOut c: String, checkInTime t: String, checkOutTime o: String, guestName g: String, guestSchool s: String, guestParentPhone n: String, guestCheckIn h: String, studentParentName spn: String, studentParentPhone spp: String) {
        firstName = f
        lastName = l
        altIDNumber = a
        idNumber = i
